...
class Simulation():
    ...
    def graphic_interface(self):
        ...
        self.visual_slider = Slider(self.screen, x_slider, int(self.margin/6) + 4*int(self.window[1]/120) + 40, int(self.window[0]/8), int(self.window[1]/120), min=0, max=40, step=1, color=(0, 0, 0), handleColour=(255, 0, 0), handleRadius=5, initial=0, handleThickness=0)
